...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden my-8 z-10 ${maxWidthClasses[maxWidth]}`}
      >
        {/* Header */}
        <div className="flex items-start justify-between p-5 sm:p-6 border-b border-slate-100 bg-slate-50/50">
          <div>
            <h3 id="modal-title" className="text-xl font-bold text-slate-900 font-display">
              {title}
            </h3>
